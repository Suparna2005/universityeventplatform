...
def generate_certificate_pdf_bytes(student_name: str, event_title: str, date_str: str, cert_number: str) -> bytes:
    ...
    c.drawCentredString(width / 2.0, height - 150, "Certificate of Participation")
    ...
    c.setFont("Helvetica", 18)
    c.drawCentredString(width / 2.0, height - 350, "has successfully participated in the event")
